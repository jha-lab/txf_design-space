...
model_dict_bert_tiny= { 'l': 2, 'o': ['l']*2, 'h': [128]*2, 'n': [2]*2, 'f': [[4*128]]*2, 'p': ['dft']*2}

fnet_tiny_graph = graphLib.get_graph(model_dict=model_dict)[0]

dataset = "cc_news"

output_dir = "../../models/pretrained/"+str(fnet_tiny_graph.hash)+'/'
